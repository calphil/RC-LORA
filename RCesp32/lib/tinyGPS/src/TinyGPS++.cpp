...
bool TinyGPSPlus::endOfTermHandler()
{
  ...
  if (isChecksumTerm)
  {
   ...
   //Serial.println("");
   //Serial.print("                                          checksum");Serial.print(checksum);Serial.print("  ");Serial.println(parity);
    if (checksum == parity)
    {
      passedChecksumCount++;
      if (sentenceHasFix)
  ...
  if (curTermNumber == 0)
  {
    ...
    {  curSentenceType = GPS_SENTENCE_GPGGA;
      //Serial.print("GPS_SENTENCE_GPGGA");//Serial.println(term);
    }
    else
      curSentenceType = GPS_SENTENCE_OTHER;
...
//Serial.print("set");//Serial.println(term);
...
//Serial.print("fix");//Serial.println(term);
      break;
